...
class Atlasp_App_Captcha extends Zend_Captcha_Image
{
    
    public function __construct(){
	parent::__construct();
	$this->setFont('/u/latest/Misc/fonts/FreeSans.ttf');
	$this->setFontSize(30);
	$this->setWordlen(6);
	$this->setWidth(175);
	$this->setHeight(70);
	...
	$word = $this->_generateWord();
        $this->_setWord($word);
        $this->_generateCaptcha($word);
        $tmp = $this->getWord();
    }

    protected function _generateCaptcha($word)
    {
