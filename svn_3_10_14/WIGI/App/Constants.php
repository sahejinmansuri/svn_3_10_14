...
class App_Constants extends Atlasp_App_Constants
{
    ...
    protected static $_formData = array(
        'labels' => array(
            ...
            'TO'               => 'To',
            'ID'               => 'Id',
            'WIGICODE_TIMEOUT' => 'InCashMe Code Timeout',
            'BIRTHDATE'        => 'Birth Date',
            'REASON'           => 'Reason',
            'WIGICODE'         => 'InCashMe Code',
            'MERCHANTID'       => 'Merchant ID',
            'ALERT_METHOD'     => 'Alert Method',
            'WIGICODE_TIMEOUT' => 'InCashMe Code Timeout',
            'INTERNATIONAL_TRANS' => 'International Transactions',
            'MAX_WIGI_AMT_TXN' => 'Max Amount Per InCashMe Transaction',
            'MAX_WIGI_AMT_DAY' => 'Max Amount of InCashMe Transactions Per Day',
			...
			'MIDDLE_INIT'	=> 'Fathers Name',
			'PAN_NO'			=> 'Pan No',
			'ANNUAL_INCOME'	=> 'Annual income',
			'SUBMITTED_ID_PROOF'	=> 'Submitted ID Proof',
			'KYC'	=> 'KYC',
			'ADDRESS_PROOF'	=> 'Address Proof',
			'LANDLINE_HOME'	=> 'Landline Home',
			'AADHAR_ID'	=> 'AADHAR ID',
			'PT_COUNTRY'	=> 'COUNTRY',
			'PT_ADDRESS'	=> 'ADDRESS',
			'PT_CITY'	=> 'CITY',
