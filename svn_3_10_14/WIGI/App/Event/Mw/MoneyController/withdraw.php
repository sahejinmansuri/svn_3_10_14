...
class App_Event_Mw_MoneyController_withdraw extends App_Event_WsEventAbstract  {
	...
	public function execute(&$session_data,&$pview,&$cthis){
		...
		if ($doaction == null) {
	        ...
	        /*if ($type == 1) {
	            ...
	            $b->fundToCreditCard($session_data->extinfo,$uid,$mobileid,$id,$amount,$u->getFirstName(),$u->getLastName(),$cc->getNameOnCard(),$cc->getExpireMonth(),$cc->getExpireYear(),$cc->getCardType(),'1',false);
	            }catch(Exception $e){
	                $params = array('E'=>1);    
	                $this->_helper->redirector->goto('showwithdraw', 'money', 'mw', $params);
	            }
	        } else if ($type == 2) { */
