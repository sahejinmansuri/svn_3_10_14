...
class App_Event_Aw_ProfileController_setdefaultcell extends App_Event_WsEventAbstract  {
	...
	public function execute(&$session_data,&$pview,&$cthis){
		...
		if ($item != null && is_numeric($item)) {
			...
			$m = new App_Messenger();
			$cellphone->sendMessage("Your cell phone confirmation code is $code. Please enter this on the website to set your default cellphone.",$cellphone->getCellphone(),2);
