...
class App_Event_Posws_DocumentController_updatedocument extends App_Event_WsEventAbstract {
    ...
    public function execute(){
                ...
                $de->updateDocument($docid,$ns->mobileid,$doctype,'1',$description,$data,$data2,$number,$expires,$same,$same2);
