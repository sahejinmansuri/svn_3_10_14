...
class App_Event_Mobws_DonateController_scandonate extends App_Event_WsEventAbstract {
    ...
    public function __construct(Zend_Controller_Request_Abstract $request = null)
    {
        ...
        $this->_evt_data = array(
            'inputs' => array(
                ...
                'WIGICODE' => array('amount', 12, 1, App_Constants::getFormLabel('WIGICODE')),
            )
        );
    }
    ...
    public function execute(){
		...
		try {
                ...
                $this->view->URLKEY = $this->_request()->getParam("KEY");
                $this->view->IDENTIFIER = $this->_request()->getParam("IDENTIFIER");
                $this->view->OSID = $this->_request()->getParam("OSID");
		...
		$result['result']['value'] = '';
		$result['result']['data']   = 'Scan and Donate™ donation completed successfully!';
