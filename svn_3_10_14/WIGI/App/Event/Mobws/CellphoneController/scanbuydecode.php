...
class App_Event_Mobws_CellphoneController_scanbuydecode extends App_Event_WsEventAbstract {
    ...
    public function execute(){
		...
		$url = $basepath."v2/mobws/cellphone/scanbuy/KEY/".$key."/IDENTIFIER/".$IDENTIFIER."/MERCHANTID/".$data['MERCHANTID']."/AMOUNT/".$data['AMOUNT']."/WIGICODE/".$data['WIGICODE']."";
		
		$success_message = "Scan and Buy™ transaction completed successfully!";
