...
class App_Event_Mobws_CellphoneController_scandonatedecode extends App_Event_WsEventAbstract {
    ...
    public function execute(){
		...
		$url = $basepath."v2/mobws/donate/scandonate/KEY/".$key."/IDENTIFIER/".$IDENTIFIER."/MERCHANTID/".$data['MERCHANTID']."/AMOUNT/".$data['AMOUNT']."/WIGICODE/".$data['WIGICODE']."";
		$filure_message = "QR code is not a valid scan and donate code";
		$success_message = "Scan and Donate™ donation completed successfully!";
