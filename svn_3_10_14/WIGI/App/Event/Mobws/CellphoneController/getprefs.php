...
class App_Event_Mobws_CellphoneController_getprefs extends App_Event_WsEventAbstract {
    ...
    public function execute(&$session_data,&$pview,&$cthis){
				...
				//$checkpermission = $cthis->checkpermission($ns->mobileid,'',3);
