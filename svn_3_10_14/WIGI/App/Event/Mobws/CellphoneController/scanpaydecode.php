...
class App_Event_Mobws_CellphoneController_scanpaydecode extends App_Event_WsEventAbstract {
    ...
    public function execute(){
		...
		$url = $basepath."v2/mobws/cellphone/scanpay/KEY/".$key."/IDENTIFIER/".$IDENTIFIER."/MERCHANTID/".$data['MERCHANT_ID']."/AMOUNT/".$data['AMOUNT']."/WIGICODE/".$data['WIGICODE']."";
		$filure_message = "QR code is not a valid scan and pay code";
		$success_message = "Scan and Pay™ transaction completed successfully!";
