...
class App_Event_Mobws_CellphoneController_sendtransaction extends App_Event_WsEventAbstract {
    ...
    public function execute(){
		...
		$dstcell = new App_Cellphone($dstmobileid);
				...
				$c_from->sendMessage("InCashMe: You have sent INR $amount to $merchantid", 'InCashMe: Money Sent',2);
				$dstcell->sendMessage("InCashMe: You have received INR $amount from " . $u_from->getFirstName() . " at " . App_DataUtils::fmtphone($dstcell->getCellphone()), 'InCashMe: Money Recieved',2);
