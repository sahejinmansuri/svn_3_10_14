...
class App_Event_Mobws_CellphoneController_tellfriends extends App_Event_WsEventAbstract {
    ...
    public function execute(){
		...
		if ($email !== "") {
			...
			$m->sendMessage($message,$email,'1','Incashme : Join InCashMe');
		} 
                else {
			...
			$m->sendMessage($message,$phone,'2');
                ...
                $result = array();
				$dataRes=array('title'=>'Success','message'=>'You have successfully notified your friend about InCashME. Thank you.');
