...
class App_Event_Mobws_CellphoneController_addmoney extends App_Event_WsEventAbstract {
    ...
    public function execute(){
					...
					throw new App_Exception_WsException('Internal Error 101');
...
//                        }
						...
						//added two lines by attune
						$to_id = $user->getDefaultCellphone();
						$c_to = new App_Cellphone($to_id);
						
                        $c_to->sendMessage("The confirmation amount for your bank account ending in $last4 is INR $conf_amt",'InCashMe: Amount Confirmation',4);
