...
class App_Event_Mobws_RegistrationController_setosid extends App_Event_WsEventAbstract {
    ...
    public function execute(&$cthis){
        ...
        //if($c->getPin() == Atlasp_Utils::inst()->encryptPassword($pin)) {
				...
				App_DataUtils::commit();
                                session_write_close();
                                $cthis->getHelper('redirector')->goto('consolidatedauth','auth','mobws',$allparams); 
                        } else {
