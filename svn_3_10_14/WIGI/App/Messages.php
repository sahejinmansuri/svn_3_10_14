...
EOF;
    ...
    public function getTxtInvite($merchName) {
       $s = "Your friend $merchName wants you to join InCashMe. InCashMe is a Mobile Wallet application that runs on your iPhone or Android phone.";
       return $s;
    }
...
To join, please visit ".$basepath."  and open an account, it's FREE!"; 
       return $s;
    }
