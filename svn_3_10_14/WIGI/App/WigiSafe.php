...
private function writeFileContent($file, $content){
  ...
  //public function addDocument($version,$keyver,$data,$data2,$number) {
...
if(!is_dir($path)){
	...
	if ($data !== "") {
      file_put_contents("/var/www/html/incash/u/data/$docid/front",$data);
    }

    if ($data2 !== "") {
      file_put_contents("/var/www/html/incash/u/data/$docid/back",$data2);
    }
            return $docid;
  }
