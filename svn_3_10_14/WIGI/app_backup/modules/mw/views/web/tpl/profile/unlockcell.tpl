		...
		<div id="page">
			...
			<div class="information">
				...
				{if $showcontent == "form"}
					...
					<div class="setup unlockposdevice formlayout subformlayout">
						
						<h4>Unlock device: {$selectedcellphone}</h4>
				...
				{elseif $showcontent == "success"}
					...
					<div class="setup unlockedposdevice">
						
						<h4>Unlock device</h4>
						
						<p>Your device has been unlocked.</p>
