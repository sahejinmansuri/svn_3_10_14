			...
			<div class="information">
				...
				{if $showcontent == "form"}
					...
					<div class="setup lockaccount formlayout subformlayout">
						...
						<p>When you Lock your Account, no new transactions of any type will be able to be initiated. You will have to call Customer Service to unlock it. All devices associated with this account will also be locked. You must have no pending transactions in order to be able to lock your account.</p>
						...
						<form action="{$formbase}profile/lockaccount" method="post" autocomplete="off">
							...
							<div class="stepbox">
								...
								<div class="prompt password">
									...
									<p class="tip">Please enter your InCashMe&#8482; Merchant Account password</p>
								</div>
				...
				{elseif $showcontent == "error"}
					...
					<div class="setup lockedaccount">
						...
						<p>Make sure you entered your password correctly, and you don't have any pending transactions.</p>
