                ...
                <div class="recrow">
                        ...
                        <div class="left">
                            <select name="dbname" style="width:200px;">
                                ...
                                <option value="wigidb">InCashMe&trade; Main</option>
                                <option value="wlogdb">InCashMe&trade; Log</option>
                                <option value="wsafedb">InCashMe&trade; Safe</option>
                                <option value="sesssb">InCashMe&trade; Session</option>
                            </select>
                        </div>
