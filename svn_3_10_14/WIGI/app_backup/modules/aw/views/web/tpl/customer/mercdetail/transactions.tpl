...
<div class="dtable">
    <div class="dhead">
        <div class="drow">
            ...
            <div class="dcol" style="width:80px;">Date</div>
    ...
    <div class="dbody">
        {foreach from=$merchants_transaction_data item=data}
            <div class="drow drowalt">
                <div class="dnormal">
                    ...
                    <div class="dcol" style="width:80px;">{date("M j, Y", strtotime($data.stamp))}</div>
