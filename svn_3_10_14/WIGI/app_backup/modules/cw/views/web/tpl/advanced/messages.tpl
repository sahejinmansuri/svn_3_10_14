			...
			<div class="information">
				...
				<div class="tabfield">
					...
					<div class="tab setup messages">
						...
						<p>Messages for {if $selectedcellalias != null}{$selectedcellalias}, {App_DataUtils::fmtphone($selectedcellphone)}{else}{App_DataUtils::fmtphone($selectedcellphone)}{/if}.</p>
									...
									<div id="{$v.id}" class="drow{if $smarty.foreach.msgs_loop.index%2} drowalt{/if}">
										...
										<div class="dextend">
											...
											<div class="expandtype transactionbox">
												...
												<p>{$v.message}</p>
												<ul class="rowactions">
													<li><a href="{$formbase}advanced/messagesdelete/C/{$item}/M/{$v.id}">Delete</a></li>
												</ul>
											</div>
										</div>
									</div>
						...
						{if count($msgs) > 0}
							<ul class="rowactions">
								<li><a href="{$formbase}advanced/messagesdelete/C/{$item}/M/all">Delete all</a></li>
							</ul>
						{/if}
