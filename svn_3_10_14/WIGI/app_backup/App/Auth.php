...
class App_Auth {
  ...
  public function userConstraintCheck($type,$userid,$password,$resetlock = true,$checkpass = true) {
    ...
    if ( $user->isPending() ) {
      throw new App_Exception_WsException('You have successfully created your account, however your account is waiting final verification by InCashMe staff.');
      return false;
    }
    ...
    if( $user->getStatus() === "unconfirmed") {
            ...
            $m = new App_Messenger();
            $m->sendMessage($emailMsg,$user->getEmail(),'1','InCashMe Message: Please verify your Email'); //email
