...
*/
  ...
  public function getHistory($mobileid,$timezone,$limit="all",$date="all") {
    ...
    foreach ($raw as $row) {
      $t = array();
      $t['type']            = $row['type'];
      $t['tax']             = /*App_DataUtils::fmtMoney*/("INR ".$row['tax']);
      $t['tip']             = /*App_DataUtils::fmtMoney*/("INR ".$row['tip']);
      $t['raw_amount']      = /*App_DataUtils::fmtMoney*/("INR ".$row['raw_amount']);
      $t['transaction_id']  = $row['transaction_id'];
      $t['viewed']          = $row['viewed'];
      $t['amount']          = /*App_DataUtils::fmtMoney*/("INR ".$row['amount']);
