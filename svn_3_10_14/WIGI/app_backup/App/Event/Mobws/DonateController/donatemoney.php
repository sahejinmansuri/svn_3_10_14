...
class App_Event_Mobws_DonateController_donatemoney extends App_Event_WsEventAbstract {
    ...
    public function execute(&$session_data,&$pview,&$cthis){
		...
		//get virtual pos id
                ...
                $c_to->sendMessage("InCashMe&trade;: You have received ₹$amount from " . $c_from->getCellphone() . " Message: $message");
