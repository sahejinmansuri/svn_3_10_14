				...
				<div id="step1">
					...
					<form action="{$formbase}login/auth" method="post" autocomplete="off">
						...
						<div class="notes morelinks">
							...
							<p>
								<a href="{$formbase}registration/home">Create a InCashMe Merchant account</a><br />
								<a href="{$formbase}login/forgotloginid">Forgot your Login ID?</a><br />
