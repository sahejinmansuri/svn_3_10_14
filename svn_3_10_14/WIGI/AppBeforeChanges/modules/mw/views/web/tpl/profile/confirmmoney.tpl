			...
			<div class="information">
				...
				{if $showcontent == "form"}
					...
					<div class="setup confirmmoney formlayout subformlayout">
						...
						<p>We have earlier withdrawn two small random amounts from your bank account as WiGi Inc. Please enter those amounts in the fields below to confirm your account. You can enter the amounts in any order.</p>
