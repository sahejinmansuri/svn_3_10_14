		...
		<div id="page">
			...
			<div class="information">
				...
				<div id="addmoney" class="setup addfunds formlayout subformlayout">
					...
					<h4>Add money to your WiGime&#8482; Merchant Account</h4>
					
					<p>You can add funds to your WiGime&#8482; Merchant Account from one of <a href="{$formbase}profile/home#moneysources" style="text-decoration:underline;">your pre-existing Money Sources</a>. These funds may take several days to appear in your Available balance, depending on the bank settlement times. We will send you an email as soon as the funds settle.</p>
