							...
							{foreach from=$cellphones item=v name=cellphones_loop}
								<div id="{$v.mobile_id}" class="drow{if $smarty.foreach.cellphones_loop.index%2} drowalt{/if}">
									<div class="dnormal">
										...
										<div class="dcol col5">
											US${number_format({$postotals[$v.mobile_id]['grand_total']}, 2, '.', ',')}
										</div>
										<div class="dcol col6">
											US${number_format({$postotals[$v.mobile_id]['charge_total']}, 2, '.', ',')}
										</div>
										<div class="dcol col7">
											US${number_format({$postotals[$v.mobile_id]['tax_total']}, 2, '.', ',')}
										</div>
										<div class="dcol col8">
											US${number_format({$postotals[$v.mobile_id]['tip_total']}, 2, '.', ',')}
										</div>
									</div>
								</div>
							{foreachelse}
