<div class="status">
	...
	<ul>
		...
		<li class="cellphones">Cell Phones {foreach name=usercells_loop from=$usercells key=v item=k}<strong{if $v != 0} class="hidden"{/if}>{$k.cellphone}: US${$k.balance}</strong>{/foreach}</li>
	</ul>
