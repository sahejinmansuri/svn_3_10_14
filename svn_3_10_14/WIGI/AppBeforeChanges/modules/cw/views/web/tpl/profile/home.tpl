						...
						<div class="tab setup preferences">
							...
							<div class="columnbox">
								...
								<div class="row">
									...
									<p class="data">US${number_format($preferences['wigi']['minbal'], 2, '.', ',')}</p>
								</div>
								{/if}
								...
								<div class="row">
									...
									<p class="data">US${number_format($preferences['wigi']['max_per_trans'], 2, '.', ',')}</p>
								</div>
								...
								<div class="row">
									<p><strong>Maximum amount per transaction</strong></p>
									<p class="data">US${number_format($preferences["gift"]["max_per_trans"], 2, '.', ',')}</p>
								</div>
								...
								<div class="row">
									...
									<p class="data">US${number_format($preferences['funding']['max_per_trans'], 2, '.', ',')}</p>
								</div>
																...
																<div style="float:left;overflow:hidden;width:240px;">
																	<div>
																		...
																		<ul>
																			...
																			<li>Balance: US${number_format($v.balance, 2, '.', ',')}</li>
																		</ul>
																	</div>
																	<div>
																...
																<div style="float:left;overflow:hidden;width:260px;">
																	...
																	<div>
																		...
																		<ul>
																			...
																			<li>Maximum amount per transaction: US${$cellpreferences[$v.mobile_id]["wigi"]["max_per_trans"]}</li>
																			...
																			<li>Maximum amount per gifts: US${$cellpreferences[$v.mobile_id]["gift"]["max_per_trans"]}</li>
																			<li>Maximum number of gifts per day: {$cellpreferences[$v.mobile_id]["gift"]["max_per_day"]}</li>
																			<li>Maximum amount per funding: US${$cellpreferences[$v.mobile_id]["funding"]["max_per_trans"]}</li>
