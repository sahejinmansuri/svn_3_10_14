                    ...
                    <div class="tab setup percentage">
                        <strong>Set Percentage Rate Billing</strong>
                        <form action="{$formbase}billing/savepercentage" method="post">
                            ...
                            <div class="dtable">
                              ...
                              <div class="dbody">
                                    ...
                                    {foreach from=$wigi_percentage_billing key=k item=v}
                                        <div class="drow">
                                            <div class="dnormal">
                                ...
                                <div class="recrow ctr">
                                    <input class="adminBtn" type="submit" value="Save Percentage Rate Billing" />
                               </div>
                           </div>
                        </form>
                    </div> 
