                        <strong>Admin WIGI Users</strong>

                        {include file='admin/search_users.tpl'}

                        <div class="dtable">
                        <strong>Existing Admin WIGI Users:</strong>
                                    ...
                                    <div class="drow drowalt">
                                        <div class="dnormal">
                                            <div class="dcol" onClick="toggleS('{$data.adminuser_id}');">
                                                {if !$data.admin}<span class="icons2"><span class="ui-state-default2 bgreen ui-corner-all"><span id="c_{$data.adminuser_id}" class="ui-icon-plus ui-icon ugreen"></span></span></span>{/if}
                                            </div>
