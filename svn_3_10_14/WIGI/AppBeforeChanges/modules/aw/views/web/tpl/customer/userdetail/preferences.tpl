    ...
    <div class="columnbox">
        ...
        <h5>General preferences</h5>
            ...
            <td width="95%">
                <ul class="resultul">
                    {if true == false}
                        <li><div class="width250 left"><strong>Minimum balance</strong></div>: US${number_format($preferences['wigi']['minbal'], 2, '.', ',')} </li>
                    {/if}
        ...
        <h5>InCashMe&#8482; Money Payment Code preferences</h5>
            ...
            <td width="95%">
                <ul class="resultul">
                    <li><div class="width250 left"><strong>Maximum amount per transaction</strong></div>: US${number_format($preferences['wigi']['max_per_trans'], 2, '.', ',')}</li>
        ...
        <h5>Send money/gift preferences</h5>
            ...
            <td width="95%">
                <ul class="resultul">
                    <li><div class="width250 left"><strong>Maximum amount per transaction</strong></div>: US${number_format($preferences["gift"]["max_per_trans"], 2, '.', ',')}</li>
        ...
        <h5>Funding preferences</h5>
            ...
            <td width="95%">
                <ul class="resultul">
                    <li><div class="width250 left"><strong>Maximum amount per funding</strong></div>: US${number_format($preferences['funding']['max_per_trans'], 2, '.', ',')}</li>
