     ...
     <div class="dbody">
	    ...
	    {foreach from=$existing_roles item=data2}
            <div style="width:85%;border-bottom:dotted #dfdfdf 1px;float:left;margin:5px;">
                <div class="spacer" onClick="toggleS('{$data2.rec_id}');"><span class="icons2"><span class="ui-state-default2 bgreen ui-corner-all"><span id="c_{$data2.rec_id}" class="ui-icon-plus ui-icon ugreen"></span></span></span></div>
