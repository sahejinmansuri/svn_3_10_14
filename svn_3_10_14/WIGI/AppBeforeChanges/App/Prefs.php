...
*/
      if ($prefs["wigi"]["timeout"] > $hardprefs["wigi"]["timeout"]) {
          $error=1;
          $errmsg .= "WiGi Code timeout[".$prefs["wigi"]["timeout"]."] can not be greater than [" . $hardprefs["wigi"]["timeout"] . "]\n";
      ...
      if ($prefs["wigi"]["max_per_trans"] > $hardprefs["wigi"]["max_per_trans"]) {
          $error=1;
          $errmsg .= "Max amount per Wigi transaction can not be greater than $" . $hardprefs["wigi"]["max_per_trans"] . "\n";
          $prefs["wigi"]["max_per_trans"] = $hardprefs["wigi"]["max_per_trans"];
      }

      if ($prefs["wigi"]["max_per_day"] > $hardprefs["wigi"]["max_per_day"]) {
          $error=1;
          $errmsg .= "Max number of Wigi transactions per day can not be greater than " . $hardprefs["wigi"]["max_per_day"]  . "\n";
