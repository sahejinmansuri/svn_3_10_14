...
class App_Bank {
  ...
  public function fundFromBankAccount($extinfo,$userid,$mobileid,$baid,$amount,$first_name,$last_name,$routing,$zip,$address,$state,$type,$processor,$linkRequired = true) {
