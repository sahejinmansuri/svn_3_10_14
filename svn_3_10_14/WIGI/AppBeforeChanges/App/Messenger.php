...
class App_Messenger {
  ...
  private static function sendViaSmsIndia($message,$to) {
    $ch = curl_init ("http://login.smsindiahub.in/API/WebSMS/Http/v1.0a/index.php?username=mayur.mi&password=mindinventory123&sender=9727577587&to=$to&message=$message&reqid=1&unique=0");
    curl_setopt ($ch, CURLOPT_RETURNTRANSFER, true);
    $page = curl_exec ($ch);
  }
}
