...
class Posws_ScaneController extends Posws_RestController
{

       
    public function addscaneAction() {
    	
    	$evt = new App_Event_Posws_ScaneController_addscane( $this->getRequest() );
      $result = $evt->execute();
    ...
    public function getqrcodeAction() {
          ...
          $evt = new App_Event_Posws_ScaneController_getqrcode( $this->getRequest() );
          $result = $evt->execute();
          $this->sendResponse($result);
    }
