							...
							<ul class="filter">
								...
								<li>
									...
									<ul class="prompt phone">
										<li><input type="text" name="SPC" value="{$SPC}" maxlength="10" /></li>
									</ul>
								</li>
								<li class="submit">
								...
								{section name=loop loop=$orders['pay']['orders']}
									<div class="drow{if $smarty.section.loop.index%2} drowalt{/if}">
										<div class="dnormal">
											...
											<div class="dcol col2"><strong>{$orders['pay']['orders'][loop].first_name} {$orders['pay']['orders'][loop].last_name}</strong></div>
											<div class="dcol col3">{$orders['pay']['orders'][loop].user_acct_no}</div>
											<div class="dcol col4">{$orders['pay']['orders'][loop].status}</div>
											...
											<div class="expandtype sbordersbox">
												<div>
													...
													<ul>
														...
														<li>
															Payer name: {$orders['pay']['orders'][loop].first_name} {$orders['pay']['orders'][loop].last_name}
															<ul>
																<li>Payer address: {$orders['pay']['orders'][loop].addr_line1}{if $orders['pay']['orders'][loop].addr_line2 != null} {$orders['pay']['orders'][loop].addr_line2}{/if}, {$orders['pay']['orders'][loop].city}, {$orders['pay']['orders'][loop].state} {$orders['pay']['orders'][loop].zip}</li>
																<li>Payer email: {$orders['pay']['orders'][loop].consumer_email}</li>
																<li>Payer phone: {$orders['pay']['orders'][loop].cellphone}</li>
															</ul>
														</li>
