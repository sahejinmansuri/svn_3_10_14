							...
							<ul class="filter">
								...
								<li>
									...
									<ul class="prompt phone">
										<li><input type="text" name="EC" value="{$EC}" maxlength="10" /></li>
									</ul>
								</li>
								<li>
								...
								{section name=loop loop=$orders['ecommerce']['orders']}
									<div class="drow{if $smarty.section.loop.index%2} drowalt{/if}">
										<div class="dnormal">
											...
											<div class="dcol col2"><strong>{$orders['ecommerce']['orders'][loop].first_name} {$orders['ecommerce']['orders'][loop].last_name}</strong></div>
											<div class="dcol col3">{$orders['ecommerce']['orders'][loop].order_id}</div>
											<div class="dcol col4">{$orders['ecommerce']['orders'][loop].status}</div>
											...
											<div class="expandtype transactionbox">
												<div>
													...
													<ul>
														...
														<li>
															Customer name: {$orders['ecommerce']['orders'][loop].first_name} {$orders['ecommerce']['orders'][loop].last_name}
															<ul>
																<li>Customer address: {$orders['ecommerce']['orders'][loop].addr_line1}{if $orders['ecommerce']['orders'][loop].addr_line2 != null} {$orders['ecommerce']['orders'][loop].addr_line2}{/if}, {$orders['ecommerce']['orders'][loop].city}, {$orders['ecommerce']['orders'][loop].state} {$orders['ecommerce']['orders'][loop].zip}</li>
																<li>Customer email: {$orders['ecommerce']['orders'][loop].consumer_email}</li>
																<li>Customer phone: {$orders['ecommerce']['orders'][loop].cellphone}</li>
															</ul>
														</li>
														<li>InCashMe&#8482; Payment Code: {$orders['ecommerce']['orders'][loop].wigi_code}</li>
