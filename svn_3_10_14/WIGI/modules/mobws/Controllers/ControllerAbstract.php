...
abstract class Mobws_ControllerAbstract extends Atlasp_ControllerAction
{
    ...
    protected function _setResponseSiteDown() {
        $this->_setResponseError(App_Ws_Types_Response::ERRNO_SITE_DISABLED);
    }
