...
class Cw_AdvancedController extends Cw_WebController {
	...
	public function documentsAction(){
          try {
            $evt = new App_Event_Cw_AdvancedController_documents( $this->getRequest() );
            $evt->execute($this->ns,$this->view,$this);
          } catch (Exception $e) {
            $a["MESSAGE"] = $e->getMessage();
            $this->redirect('usererror','usererror','cw',$a);
	...
	public function messageAction(){
          try {
            $evt = new App_Event_Cw_AdvancedController_message( $this->getRequest() );
            $evt->execute($this->ns,$this->view,$this);
          } catch (Exception $e) {
            $a["MESSAGE"] = $e->getMessage();
            $this->redirect('usererror','usererror','cw',$a);
	...
	public function movefundAction(){
          try {
            $evt = new App_Event_Cw_AdvancedController_movefund( $this->getRequest() );
            $evt->execute($this->ns,$this->view,$this);
          } catch (Exception $e) {
            $a["MESSAGE"] = $e->getMessage();
            $this->redirect('usererror','usererror','cw',$a);
