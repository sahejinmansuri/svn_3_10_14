...
abstract class Aw_ControllerAbstract extends Atlasp_ControllerAction
{
    ...
    public function set_default_tpls() {
        ...
        if ($moduleName != 'default') {
            ...
            $this->view->formbase = $orig_basehref.$cfg->version.'/aw/';
            $this->view->formfull = $cfg->paths->baseurl.$cfg->version.'/aw/';
