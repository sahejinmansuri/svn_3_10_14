                ...
                <div class="recrow">
                        ...
                        <div class="left">
                            <select name="app" style="width:200px;">
                                ...
                                <option value="mw">InCashMe&trade; Merchant</option>
                                <option value="cw">InCashMe&trade; Consumer</option>
                                <option value="posws">InCashMe&trade; Pos</option>
                                <option value="mobws">InCashMe&trade; Mobile</option>
                                <option value="wsafe">InCashMe&trade; Safe</option>
                            </select>
                        </div>
