        ...
        {foreach from=$consumers_mobile_info_data item=data}
            <div class="drow drowalt">
                <div class="dnormal">
                    ...
                    <div class="dcol summarycol3">₹{number_format($data.balance, 2, '.', ',')}</div>
                </div>
            </div>
            ...
            <div id="{$data.mobile_id}" style="display:none;padding:10px;background:#E4F5C8;padding:4px;">
                        ...
                        <td width="54%">
                            ...
                            <ul class="resultul">
                                ...
                                <li><div class="width200 left">Maximum amount per gifts</div>: ₹{$data.preferences['gift'].max_per_trans}</li>
                                <li><div class="width200 left">Maximum # of gifts per day</div>: {$data.preferences['gift'].max_per_day}</li>
                                <li><div class="width200 left">Maximum amount per funding</div>: ₹{$data.preferences['funding'].max_per_trans}</li>
