            ...
            <div id="profile" class="setup profile columnlayout">
                ...
                <div class="tabfield">
                    <div class="tabnavigation">
                        ...
                        <ul>
                            <li><a href="{$formfull}customer/showdiscount?MID={$mid}">Special Billing</a></li>
                            <li><a href="{$formfull}customer/mercdetail?MID={$mid}#merchantinfo">Merchant info</a></li>
                            <li><a href="{$formfull}customer/mercdetail?MID={$mid}#moneysources">Money sources</a></li>
                            <li><a href="{$formfull}customer/mercdetail?MID={$mid}#preferences">Preferences</a></li>
                            {if true == false}<li><a href="{$formfull}customer/mercdetail?MID={$mid}#posdevices">Devices</a></li>{/if}
                            <li><a href="{$formfull}customer/mercdetail?MID={$mid}#users">POS users</a></li>
                            <li><a href="{$formfull}customer/mercdetail?MID={$mid}#billing">Billing</a></li>
                            <div style="clear:both;"></div><br/>
                            <li style="border-bottom:5px solid #82B038;"><a href="{$formfull}customer/mercdetail?MID={$mid}#transactions">Transactions</a></li>
                            <li style="border-bottom:5px solid #82B038;"><a href="{$formfull}customer/mercdetail?MID={$mid}#login_history">Login History</a></li>
                        </ul>
                    </div>

                    <div class="tab setup discounts">
                        <strong>Set Special Billing | For the month of {$month}.</strong><br/>
                        <form action="{$formfull}customer/msavediscount" method="post" id="usrsearch">
