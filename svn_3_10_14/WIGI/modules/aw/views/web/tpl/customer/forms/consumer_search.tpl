...
</span>&nbsp;Search Consumers
</h4>
        <div style="background:#E4F5C8;padding:4px;">
        <form action="{$formbase}customer/usersearch" method="get" id="txsearch">

                <div class="recrow">
                        <div class="left2 b" style="width:150px;">Consumer Status</div>
                        <div class="left">
                ...
                <div class="recrow ctr">
                    <input class="adminBtn" type="submit" value="Search Consumers" />
               </div>
        </form>
        </div>
